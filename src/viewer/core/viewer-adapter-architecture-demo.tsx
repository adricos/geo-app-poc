  ...
  return (
    <section className='viewer-adapter-demo' aria-labelledby='viewer-adapter-demo-title'>
      ...
      <p className='viewer-adapter-demo__text'>
        ...
        <code>maplibre/</code>, <code>mapbox/</code>, <code>cesium/</code>. The store holds
        whichever viewer is mounted.
      </p>
      <button
        type='button'
      ...
      {!adapter && (
        <p className='viewer-adapter-demo__muted'>
          Switch away and back if the map is still loading.
        </p>
      )}
    </section>
  );
